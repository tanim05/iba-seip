                        ...
                        <div class="row">
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="990">990</span>
                                        </div>
                                        <div class="item-title">Total Participants</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="2970">2970</span>
                                        </div>
                            ...
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span class="counter" data-num="33">33</span>
                                        </div>
                                        <div class="item-title">Total Batch</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                                <div class="dashboard-summery-two">
                                    ...
                                    <div class="item-content">
                                        <div class="item-number"><span></span><span class="counter"
                                                data-num="000">000</span></div>
                                        <div class="item-title">Total Graduated</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="student-report">
                                    <div class="student-count pseudo-bg-blue">
                                        <h4 class="item-title">Female Participants</h4>
                                        <div class="item-number">10,500</div>
                                    </div>
                                    <div class="student-count pseudo-bg-yellow">
                                        <h4 class="item-title">Male Participants</h4>
                                        ...
                                        <table class="table display data-table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student2.png"
                                                            alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student3.png"
                                                            alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student4.png"
                                                            alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student5.png"
                                                            alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student6.png"
                                                            alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student7.png"
                                                            alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student8.png"
                                                            alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student9.png"
                                                            alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="img/figure/student10.png"
                                                            alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jul 2021 11:38:55 GMT -->
