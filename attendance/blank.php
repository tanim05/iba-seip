...
<body>
        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="index.php">
                        <img src="img/seip1.png" alt="logo">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="ibaseip/admin/intake/index.php" class="nav-link"><i
                                    class="flaticon-open-book"></i><span>Intake</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <!-- <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="notification-alart.php" class="nav-link"><i
 ...
 <!-- Footer Area Start Here -->
                <footer class="footer-wrap-layout1  ">
                    <div class="copyright">© Copyrights <a href="#">SEIP-IBA, DU</a> 2021. All rights reserved.</div>
                </footer>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Jul 2021 11:38:37 GMT -->
