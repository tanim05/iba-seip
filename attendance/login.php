        ...
        <div class="login-page-content">
            <div class="login-box">
                ...
                <div class="login-social">
                    <!-- <p>or sign in with</p> -->
                    <ul>
                        <li><a href="https://mof.gov.bd"><img src="../img/BD-Govt-logo.png" alt="Bangladesh Govt"></a></li>
                        <li><a href="https://seip-fd.gov.bd"><img src="../img/seip-logo.png" alt="SEIP"></a></li>
                        <li><a href="https://www.iba-du.edu"><img src="../img/iba.png" alt="IBA"></a></li>
                    </ul>
                </div>
            </div>
