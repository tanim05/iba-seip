<?php
    ...
    $course = array();
    $courseDropdown = '<option value="">Select Option</option>';
    while($row = mysqli_fetch_array($result))
    {
        $courseDropdown .= '<option value="'.$row[1].'">'.$row[1].'</option>';
    }
    mysqli_close($conn);
?>
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="index3.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Participants</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="ibaseip/admin/course/index.php" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="ibaseip/admin/subject/index.php" class="nav-link"><i
                                    class="flaticon-open-book"></i><span>Subject</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="ibaseip/admin/schedule/index.php" class="nav-link"><i
                                    class="flaticon-calendar"></i><span>Class
                                    Routine</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="ibaseip/admin/class/index.php" class="nav-link"><i
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="student-details.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Participants Admission</a>
                                </li>
                                <li class="nav-item">
                                    <a href="admit-form.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Form</a>
                                </li>
                                <li class="nav-item">
                                    <a href="student-promotion.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Participants Promotion</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="ibaseip/admin/percent/index.php" class="nav-link"><i
                                    class="flaticon-shopping-list"></i><span>Grade Percentage</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="ibaseip/admin/exam1/index.php" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="ibaseip/admin/user/index.php" class="nav-link"><i
                                    class="flaticon-settings"></i><span>User</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="account-settings.html" class="nav-link"><i
                                    class="flaticon-technological"></i><span>Self
                                    Profile</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                ...
                                <form class="new-added-form">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <select class="select2" id="courseDropdown">
                                                <?php echo $courseDropdown; ?>
                                            </select>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Select Class</label>
                                            <select class="select2" id="classDropdown">
                                            </select>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
        ...
        <table class="table table-striped table-bordered" id="attendance_table">
          <thead>
            <tr>
              <th>Student Name</th>
              <th>Roll Number</th>
              <th>Intake-Batch-Module-subject</th>
          ...
          <tr>
              ...
              <td>Student Name</td>
              <td>Roll Number</td>
              <td>Intake-Batch-Module-subject</td>
...
<script type="text/javascript" src="attendence/js/bootstrap-datepicker.js"></script>
<link rel="stylesheet" href="attendence/css/datepicker.css" />
...
<style>
    ...
    <script>
        $("#courseDropdown").change(function(){
            var courseVal = $("#courseDropdown").val();
            // alert(courseVal);
            $.ajax({
                url:"classCallWithAjax.php",
                method:'POST',
                ...
                {
                    console.log(data);
                    $('#classDropdown').html(data);
                    //alert(data.holding_id_present);
                    // holdnew +='<option value="">Select Class</option>';
                    // data.forEach(function(element) {
                    //     holdnew  += "<option value = '"+ element.holding_id_present + "'>"+ element.holding_id_present +"</option>";
                    // });
                }
            });
        });
  ...
  $('#add_button').click(function(){
    $('#modal_title').text("Add Attendance Ok");
